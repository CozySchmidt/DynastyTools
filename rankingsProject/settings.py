"""
Django settings for rankingsProject project.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'TrevorIsSimp')
...
WSGI_APPLICATION = 'rankingsProject.wsgi.application'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR,'rankingsProject/static')]
